      ...
      <header>
        <div className="container ">
          <div className="navigation">
            ...
            <div className="col-3 navcontainer">
              <div>
                <nav>
                  <ul className="nav_list">
                    <li>
                      <NavLink to="map" className={({ isActive }) => (isActive ? "nav-item nav-item-active" : "nav-item")}>
                        Map
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="multiviewer" className={({ isActive }) => (isActive ? "nav-item nav-item-active" : "nav-item")}>
                        Multiviewer
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="zone" className={({ isActive }) => (isActive ? "nav-item nav-item-active" : "nav-item")}>
                        Zone kort
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="test" className={({ isActive }) => (isActive ? "nav-item nav-item-active" : "nav-item")}>
                        Test
                      </NavLink>
                    </li>
                  </ul>
